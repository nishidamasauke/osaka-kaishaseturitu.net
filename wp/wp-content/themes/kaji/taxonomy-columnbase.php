			...
			<?php if (have_posts()) : ?>
				<?php while (have_posts()) : the_post(); ?>
					<article>
						...
						<p class="img"><a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('blog-column'); ?></a></p>
						<?php } ?>
						<div class="text">
						<p><time><?php echo get_the_date('Y年m月d日'); ?></time><span class="cat"><?php echo get_the_term_list($post->ID, 'columnbase'); ?></span></p>
